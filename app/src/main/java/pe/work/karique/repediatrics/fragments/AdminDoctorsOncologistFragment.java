...
public class AdminDoctorsOncologistFragment extends Fragment {
    ...
    public AdminDoctorsOncologistFragment() {}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_admin_doctors_oncologist, container, false);
    }
    ...
    private void getSpecialists(){
        ...
        AndroidNetworking.get(RepediatricsApi.SPECIALISTS_URL)
